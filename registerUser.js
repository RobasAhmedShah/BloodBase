...
async function main() {
    try {
        ...
        console.log('Creating a CA client...');
        ...
        console.log('Building user object for admin...');
        const provider = wallet.getProviderRegistry().getProvider(adminIdentity.type);
        const adminUser = await provider.getUserContext(adminIdentity, 'admin');
        console.log('Admin user built successfully');
        ...
        console.log('User registered successfully. Secret:', secret);
